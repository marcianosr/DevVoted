...
export const configs: Config[] = [
	...
	},
	{
		id: "cookies-config",
		name: "Cookies",
		image: "/configs/cookies.png",
		cost: STORAGE_UNITS.KB * 128,
		description:
			"On install, choose a consent policy. [Accept All] +512KB storage but exposes your deck. [Reject All] +128KB storage, deck stays private. Choice is permanent.",
		rarity: "common",
		effect: [],
		priority: 100,
		variants: [
			{
				id: "cookies-accept-all-config",
				label: "Accept All",
				description:
					"+512KB storage. Your config deck is exposed to all players.",
			},
			{
				id: "cookies-reject-all-config",
				label: "Reject All",
				description: "+128KB storage. Deck stays private.",
			},
		],
	},
	{
		...
		image: "/configs/cookies.png",
		cost: STORAGE_UNITS.KB * 128,
		description: "+512KB storage. Your config deck is exposed to all players.",
		rarity: "uncommon",
		effect: ["expandStorage", "exposeConfigDeck"],
		priority: 100,
		storageBonus: STORAGE_UNITS.KB * 512,
		variantOf: "cookies-config",
	},
	{
		id: "cookies-reject-all-config",
		...
		effect: ["expandStorage"],
		priority: 100,
		storageBonus: STORAGE_UNITS.KB * 128,
		variantOf: "cookies-config",
	},
	{

...
export const CONFIGS = {
	js: {
		...
		gives: "Then JavaScript polls earn ×1.5",
		needs: "Get 1 JavaScript poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "js",
	},
	ts: {
		...
		gives: "Then TypeScript polls earn ×1.5",
		needs: "Get 1 TypeScript poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "ts",
	},
	css: {
		...
		gives: "Then CSS polls earn ×1.5",
		needs: "Get 1 CSS poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "css",
	},
	jsx: {
		...
		gives: "Then React polls earn ×1.5",
		needs: "Get 1 React poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "react",
	},
	git: {
		...
		gives: "Then Git polls earn ×1.5",
		needs: "Get 1 Git poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "git",
	},
	rb: {
		...
		gives: "Then Ruby polls earn ×1.5",
		needs: "Get 1 Ruby poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "ruby",
	},
	html: {
		...
		gives: "Then HTML polls earn ×1.5",
		needs: "Get 1 HTML poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "html",
	},
	java: {
		...
		gives: "Then Java polls earn ×1.5",
		needs: "Get 1 Java poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
		focusCategory: "java",
	},
	py: {
		...
		gives: "Then Python polls earn ×1.5",
		needs: "Get 1 Python poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
	...
	frontend: {
		...
		gives: "Then Frontend polls earn ×1.5",
		needs: "Get 1 Frontend poll right",
		requirementDelta: 0,
		rewardMultiplier: 1,
	...
	coldStart: {
		...
		gives: "Then it earns ×2 coverage",
		needs: "Get your first answer right",
		requirementDelta: 0,
		rewardMultiplier: 1,

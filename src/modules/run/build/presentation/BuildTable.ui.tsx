...
type BuildTableProps = {
	 ...
	 * build's slots (configure, shop) number their rows; the gate report has
...
/**
 * The shared build list: a three-column grid — state mark · config ·
 * counter — whose rows are subgrids, so every build surface (configure,
 * answering, gate report, shop) lines its marks, names, and counters up the
 * same way on any screen width. Children are the rows: BuildReportRow

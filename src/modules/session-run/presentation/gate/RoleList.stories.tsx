...
import { describeConfig } from "~/modules/session-run/configs/config.model";
import { CONFIGS } from "~/modules/session-run/configs/configRoster.model";
import type { RoleRow } from "~/modules/session-run/gate/configRole.model";
import { RoleList } from "./RoleList.ui";

const meta: Meta<typeof RoleList> = {
	component: RoleList,
	title: "Session Run/RoleList",
};
export default meta;

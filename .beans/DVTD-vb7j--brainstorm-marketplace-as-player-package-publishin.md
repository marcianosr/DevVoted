...
DVTD-8f3i now carries the marketplace design (availability model, public builds, escrow bids on live builds). Read that before brainstorming further here: player-published packages is a different axis from trading configs that already exist.

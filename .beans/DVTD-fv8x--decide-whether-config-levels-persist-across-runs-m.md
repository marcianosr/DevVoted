---
# DVTD-fv8x
title: Decide whether config versions carry over between runs
status: draft
type: feature
priority: normal
created_at: 2026-08-06T16:44:19Z
updated_at: 2026-09-24T12:49:28Z
parent: DVTD-d0fw
---

**What:** Decide whether a config's version should survive a run, and build the meta upgrade path if it should.

**Why:** What shipped is per-run only; the original plan assumed versions you keep, and nobody has picked.

## Done when
- [ ] The decision is written down: per-run only, or versions you keep
- [ ] If they persist: what they cost, what pays for them, and where you buy them
- [ ] The chip shows the ceiling next to the version, not just the version

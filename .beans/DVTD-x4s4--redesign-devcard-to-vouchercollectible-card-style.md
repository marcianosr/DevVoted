...
## Summary of Changes\n\nRewrote DevCard with a voucher/collectible card aesthetic:\n- Category name as a colored top banner label\n- Large initials (or photo) as central art with radial glow using the category theme color\n- Text-shadow glow on initials for extra visual punch\n- Dashed ticket divider with circular notch cutouts bleeding outside the card border\n- Removed the old Avatar sub-component (inlined into DevCard)
